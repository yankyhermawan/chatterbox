export default function Home() {
  return (
    // PAGE
    <div className="flex flex-col bg-medium-grey w-screen h-screen py-4 px-6">
      <div className="flex flex-row justify-between flex-wrap items-center py-4">
        <div className="py-2 text-left text-white gap-2">
          ...
          <a
            href="/channel"
            className="py-2 px-3 font-medium border text-white rounded-lg bg-blue"
          >
        ...
        <img
          ...
          src="https://generation-sessions.s3.amazonaws.com/b48376f6ff1ee2766c8a9e891ae13078/img/3780782-77881-1.png"
          alt="home"
        />
      </div>
    </div>
